...
import com.cozs.qrcode.module.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        ...
        try {
            ...
            // Driver failed
            Logger.e(TAG,  "Camera rejected parameters. Setting only minimal safe-mode parameters");
            Logger.e(TAG,  "Resetting to saved camera params: " + parametersFlattened);
            // Reset:
            if (parametersFlattened != null) {
                ...
                try {
                    ...
                    // Well, darn. Give up
                    Logger.e(TAG,  "Camera rejected even safe-mode parameters! No configuration");
                }
            }
        }
...
//            rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
    ...
    public synchronized void setManualFramingRect(int width, int height) {
        if (initialized) {
            ...
            Logger.e(TAG,  "Calculated manual framing rect: " + framingRect);
            framingRectInPreview = null;
        } else {

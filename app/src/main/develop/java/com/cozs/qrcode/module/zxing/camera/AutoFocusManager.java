...
final class AutoFocusManager implements Camera.AutoFocusCallback {
    ...
    AutoFocusManager(Context context, Camera camera) {
        ...
        Logger.e(TAG, "Current focus mode '" + currentFocusMode + "'; use auto focus? " + useAutoFocus);
        start();
    }
    ...
    private synchronized void autoFocusAgainLater() {
        if (!stopped && outstandingTask == null) {
            ...
            try {
                ...
                Logger.e(TAG, "Could not request auto focus  Exception=" + ree);
            }
        }
    }
        ...
        if (useAutoFocus) {
            ...
            if (!stopped && !focusing) {
                try {
                    ...
                    Logger.e(TAG, "Unexpected exception while focusing  Exception=" + re);
    ...
    synchronized void stop() {
        ...
        if (useAutoFocus) {
            ...
            try {
                ...
                // Have heard RuntimeException reported in Android 4.0.x+; continue?
                Logger.e(TAG, "Unexpected exception while cancelling focusing  Exception=" + re);
            }
        }
    }

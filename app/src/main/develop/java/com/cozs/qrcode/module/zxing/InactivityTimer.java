...
final class InactivityTimer {
    ...
    void onActivity() {
        ...
        try {
            ...
            Logger.e(TAG,  "Couldn't schedule inactivity task; ignoring");
        }
    }
    ...
    void onPause() {
        ...
        if (registered) {
            ...
            Logger.e(TAG,  "PowerStatusReceiver was never registered?");
        }
    }

    void onResume() {
        if (registered) {
            Logger.e(TAG,  "PowerStatusReceiver was already registered?");
        } else {
    ...
    private static class InactivityAsyncTask extends AsyncTask<Object,Object,Object> {
        ...
        protected Object doInBackground(Object... objects) {
            try {
                ...
                Logger.e(TAG,  "Finishing activity due to inactivity");

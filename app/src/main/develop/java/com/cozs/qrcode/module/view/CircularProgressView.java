...
public class CircularProgressView extends View {
    ...
    protected Paint mBackPaint, mProgPaint;   // 绘制画笔
    protected RectF mRectF;       // 绘制区域
    protected int[] mColorArray;  // 圆环渐变色
    protected int mProgress;      // 圆环进度(0-100)
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        startAngle = typedArray.getInteger(R.styleable.CircularProgressView_startAngle, 275);
        typedArray.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, startAngle, 360*1f * mProgress / 100, false, mProgPaint);
    }
